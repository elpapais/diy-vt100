...
#define VT100_CHAR_PROP_BLINK BIT3

/* row use only */
#define VT100_CHAR_PROP_TOUCH BIT4
#define VT100_CHAR_PROP_DOUBLE_HEIGHT_BOTTOM BIT5
#define VT100_CHAR_PROP_DOUBLE_HEIGHT_TOP BIT6
#define VT100_CHAR_PROP_DOUBLE_WIDTH BIT7
